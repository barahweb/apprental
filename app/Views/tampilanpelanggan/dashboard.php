...
<section class="section-padding gray-bg">
    <div class="container">
        <div class="section-header text-center">
            <h2>Temukan Motor <span>Yang Tepat Untuk Anda</span></h2>
        ...
        <div class="row">
            ...
            <div class="recent-tab">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">List Beberapa Motor</a></li>
                </ul>
            </div>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="resentnewcar">
                    ...
                    $sql = $db->query("SELECT * from motor join type using(id_type) where status='tersedia' LIMIT 9")->getResultArray();
                    $cnt = 1;
                    if (count($sql) > 0) {
                    ...
                    ?>
                            <div class="col-list-3">
                                <div class="recent-car-list">
                                    <div class="car-info-box"> <a href="/detailmotor/<?= $result['id_motor']; ?>"><img src="<?= base_url() ?>/img/<?= $result['gambar']; ?>" class="img-responsive" alt="image" style="height: 200px; width: 360px;"></a>
                                        <ul>
                                    ...
                                    <div class="car-title-m">
                                        <h6><a href="/detailmotor/<?= $result['id_motor']; ?>"> <?php echo $result['merk'] ?></a></h6>
